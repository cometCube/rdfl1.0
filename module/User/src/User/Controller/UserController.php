...
public function addUserAction()
    ...
    public function processAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $this->getAuthService($usernameType)->getAdapter()->setIdentity($s);
                $this->getAuthService($usernameType)->getAdapter()->setCredential($this->request->getPost('password'));
    ...
    $request = $this->getRequest ();
                        ...
                        if ($request->isPost ()) {
                            ...
                            if ($del == 'Confirm') {
                                ...
                                $this->getClientusersTable ()->deleteUser ( $id,$userid);
                            }
     ...
     public function deleteUserConfirmAction() {
        $request = $this->getRequest ();
         ...
         $id = $this->params()->fromRoute('id');
                ...
                //                 $id = ( int ) $request->getPost ( 'id' );
                                $this->getClientusersTable ()->deleteUser ( $id);
                           // }
                            
                            // Redirect to list of albums
                            return $this->redirect ()->toRoute ( 'user/userProfile' );
                     //   }                 
    }
    ...
    public function userProfileAction()
    {
        ...
        return new ViewModel(array(
            ...
            'userdata' => $this-> getClientusersTable()->userlist(),
    ...
    public function generalProfileUpdateAction()
    {
        ...
        $profileData = array(
            ...
            'profilePic' => $request->getPost('profilePic')
        );
    ...
    public function verifyOldPasswordAction()
    {
        ...
        $this->getAuthService($usernameType)->getAdapter()->setIdentity($clientId);
        
        $this->getAuthService($usernameType)->getAdapter()->setCredential($this->request->getPost('oldPassword'));
